export default {
  ...
  description_2:
    'Experienced in Xamarin.Forms development and {dotnet_maui} migration research and implementation.',

  timetec_1:
    'Core contributor to a team-based cross-platform mobile app (Android, iOS, Huawei) built from scratch using Xamarin.Forms, owning core modules including {timetec_modules}.',
  timetec_2:
  ...
  timetec_4:
    'Created team-wide reusable components (Regex utilities, Extension methods, Layouts, UI components, Dialog abstractions) to improve code reuse and development efficiency.',
  timetec_5: 'Leveraged {ai_tools} to improve workflow efficiency and accuracy.',
  timetec_6:
    'Recognized as {timetec_award} for high-impact technical contributions and strong ownership of critical systems.',
  ...
  description_timetec: 'Human Resource, Security and Property Management Solutions.',
  description_freelance:
    'Provided web development services for clients for learning and skill growth.',

  // add placeholders content
  dotnet_maui: '.NET MAUI',
  timetec_modules: 'Leave, Claim, and Payroll',
  ai_tools: 'AI tools (ChatGPT, DeepSeek, GitHub Copilot, Gemini, etc.)',
  timetec_award: '2024 Top Performer',
}
